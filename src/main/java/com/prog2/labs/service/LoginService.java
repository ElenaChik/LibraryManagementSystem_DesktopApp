...
public class LoginService {
	 ...
	 * @param manager
	 */
	public LoginService(LibraryManager manager) {
	...
	public FormResponse<String> login(String login, String password) {
		...
		// [5] set User and Session into LinraryManager
		updateLibraryManager(user);
	...
	/**
	 * Method updateLibraryManager
	 *   set Session and active User
	 *
	 * @param user
	 */
	private void updateLibraryManager(User user) {
		manager.setUser(user);
		manager.setSession(roleToSessionType(user.getRole()));
	}
}
